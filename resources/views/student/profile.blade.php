        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center py-4">
                ...
                <div class="flex items-center space-x-4">
                    <a href="{{ route('student.dashboard') }}" class="bg-gray-100 text-gray-700 px-4 py-2 rounded-lg font-medium hover:bg-gray-200 transition">Back to Dashboard</a>
                    <a href="{{ route('student.logout') }}" class="bg-red-500 text-white px-4 py-2 rounded-lg font-medium hover:bg-red-600 transition">Logout</a>
                </div>
            </div>
        </div>
    </header>
    ...
    <main class="max-w-3xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
        <div class="bg-white shadow rounded-lg">
            <div class="px-4 py-5 sm:p-6">
                <h3 class="text-lg leading-6 font-medium text-gray-900 mb-6">Student Profile Information</h3>
                ...
                <form class="space-y-6">
                    <div class="flex items-center space-x-6 mb-6">
                        ...
                        <div>
                            <h4 class="text-xl font-bold">{{ $student->first_name }} {{ $student->last_name }}</h4>
                            <p class="text-gray-500">{{ $student->major }}</p>
                        </div>
                    </div>
